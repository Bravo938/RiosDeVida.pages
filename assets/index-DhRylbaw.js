...
`,bf=()=>{const[e,t]=w.useState(!1),[n,r]=w.useState(!1);w.useEffect(()=>{const s=()=>{t(window.scrollY>50)};return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]);const o=()=>r(!n),i=s=>{const l=document.getElementById(s);l&&l.scrollIntoView({behavior:"smooth"})};return a.jsxs(ak,{scrolled:e,children:[a.jsx(lk,{scrolled:e,children:a.jsx("a",{href:"/",children:"Ríos de Vida"})}),a.jsxs(uk,{onClick:o,children:[a.jsx("span",{}),a.jsx("span",{}),a.jsx("span",{})]}),a.jsxs(ck,{menuOpen:n,children:[a.jsx(Wo,{as:"button",onClick:()=>i("grupoDeVida"),scrolled:e,children:"Grupos"}),a.jsx(Wo,{as:"button",onClick:()=>i("servicios"),scrolled:e,children:"Servicios"}),a.jsx(Wo,{children:a.jsx(W,{to:"/eventos",children:"Eventos"})}),a.jsx(Wo,{children:a.jsx(W,{to:"/jovenes",children:"Mas Sobre Nosotros"})}),a.jsx(Wo,{children:a.jsx(W,{to:"/notas",children:"Notas"})}),a.jsx(dk,{children:a.jsx(W,{to:"/login",children:"Login"})})]})]})},ak=k.header`
  position: fixed;
  top: 0;
  width: 100%;
  display: flex;
...
`,e2=k.img`
  ...
  border-radius: 8px;
`,t2=()=>a.jsxs(n2,{id:"servicios",children:[a.jsxs(Fh,{direction:"left",children:[a.jsx(Bh,{src:X.auditorio,alt:"Auditorio Centro Cristiano"}),a.jsx(Uh,{children:"Auditorio Centro Cristiano Ríos de Vida"}),a.jsx(Vh,{children:"Leer Más"})]}),a.jsxs(Fh,{direction:"right",children:[a.jsx(Bh,{src:X.ccrv_Ser,alt:"Servicios Todos los Domingos"}),a.jsx(Uh,{children:"Servicios Todos los Domingos"}),a.jsx(Vh,{children:"Leer Más"})]})]}),n2=k.div`
  display: flex;
...
`,p$=()=>{const{setAuth:e}=w.useContext(ts),t=ge(),[n,r]=w.useState(!0),o=()=>{e(null),localStorage.removeItem("token"),t("/login")},i=()=>{r(!1),t(-1)};return a.jsxs(h$,{children:[n&&a.jsx(u$,{onConfirm:o,onCancel:i}),!n&&a.jsx("div",{children:"Cerrando sesión..."})]})},h$=k.div`
  ...
  justify-content: center;
  align-items: center;
`,m$=["xxl","xl","lg","md","sm","xs"],g$="xs",v$=w.createContext({prefixes:{},breakpoints:m$,minBreakpoint:g$});function x$(e,t){const{prefixes:n}=w.useContext(v$);return e||n[t]||t}const At=w.forwardRef(({bsPrefix:e,className:t,striped:n,bordered:r,borderless:o,hover:i,size:s,variant:l,responsive:u,...c},d)=>{const f=x$(e,"table"),h=Lk(t,f,l&&`${f}-${l}`,s&&`${f}-${s}`,n&&`${f}-${typeof n=="string"?`striped-${n}`:"striped"}`,r&&`${f}-bordered`,o&&`${f}-borderless`,i&&`${f}-hover`),v=a.jsx("table",{...c,className:h,ref:d});if(u){let g=`${f}-responsive`;return typeof u=="string"&&(g=`${g}-${u}`),a.jsx("div",{className:g,children:v})}return v});var jt={},zl={},Dr={},Jx={},Pf={},Br={},Lo={};/**
 * @license React
...
`,G3="https://backend-riosdevida-production.up.railway.app",n0=`${G3}/api/miembros/`,J3=()=>{const[e,t]=w.useState(""),[n,r]=w.useState(""),[o,i]=w.useState(localStorage.getItem("idUser")),s=ge(),{id:l}=cr(),u=localStorage.getItem("token"),c=async h=>{h.preventDefault(),await P.put(n0+l,{nombre:e,apellido:n,id_líder:o},{headers:{Authorization:`Bearer ${u}`}}),s("/planillaLider")};w.useEffect(()=>{d()},[]);const d=async()=>{const h=await P.get(n0+l,{headers:{Authorization:`Bearer ${u}`}});t(h.data.nombre),r(h.data.apellido)},f=()=>{s("/planillaLider")};return a.jsx(K3,{children:a.jsx(X3,{children:a.jsxs("div",{className:"form-wrapper",children:[a.jsx("h3",{children:"Editar Cliente"}),a.jsxs("form",{onSubmit:c,children:[a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Nombre"}),a.jsx("input",{value:e,onChange:h=>t(h.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Apellido"}),a.jsx("input",{value:n,onChange:h=>r(h.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"button-group",children:[a.jsx("button",{type:"submit",className:"btn btn-primary",children:"Guardar"}),a.jsx("button",{type:"button",className:"btn btn-secondary",onClick:f,children:"Cancelar"})]})]})]})})})},K3=k.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100vh;
...
`,VR="https://backend-riosdevida-production.up.railway.app",a0=`${VR}/api/supervisorLider/`;function HR(){const[e,t]=w.useState([]),n=w.useRef(null);w.useEffect(()=>{o()},[]);const r=localStorage.getItem("token"),o=async()=>{try{const l=await P.get(a0,{headers:{Authorization:`Bearer ${r}`}});t(l.data)}catch(l){console.error("Error al obtener los miembros",l),l.response&&l.response.status===401&&console.log("Token expiró")}},i=async l=>{if(window.confirm("¿Estás seguro de que deseas eliminar este miembro?"))try{await P.delete(`${a0}/${l}`,{headers:{Authorization:`Bearer ${r}`}}),o()}catch(u){console.error("Error al eliminar un Miembro:",u)}},{onDownload:s}=jt.useDownloadExcel({currentTableRef:n.current,filename:"Planilla de Supervisores",sheet:"Usuarios"});return a.jsxs(WR,{children:[a.jsx(qR,{children:a.jsx("div",{children:a.jsx(W,{to:"/menuInicio",children:a.jsx(St,{})})})}),a.jsxs(GR,{children:[a.jsxs(W,{to:"/crearAsignarSupervisor",className:"btn btn-primary create-client",children:[a.jsx(Pn,{})," Asignar Supervisor"]}),a.jsxs("button",{onClick:s,className:"btn btn-primary download-client",children:[a.jsx(zt,{})," Planilla de Supervisores"]})]}),a.jsxs(JR,{striped:!0,bordered:!0,hover:!0,ref:n,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{children:"#"}),a.jsx("th",{children:"Nombre de Supervisor"}),a.jsx("th",{children:"Nombre de Lider"}),a.jsx("th",{children:"Boton"})]})}),a.jsx("tbody",{children:e.map((l,u)=>a.jsxs("tr",{children:[a.jsx("td",{children:u+1}),a.jsx("td",{children:`${l.supervisor.nombre} ${l.supervisor.apellido}`}),a.jsx("td",{children:`${l.lider.nombre} ${l.lider.apellido}`}),a.jsxs("td",{children:[a.jsx(W,{to:`/editarAsignacionSupervisor/${l.id_registro}`,className:"btn btn-info",children:a.jsx(It,{})}),a.jsx("button",{onClick:()=>i(l.id_registro),className:"btn btn-danger",children:a.jsx(Lt,{})})]})]},l.id_registro))})]})]})}const WR=k.div`
  padding: 100px 2px;
  min-height: 100vh; 
  overflow-x: auto;
`,qR=k.div`
...
`,Xf="https://backend-riosdevida-production.up.railway.app",l0=`${Xf}/api/supervisorLider/`,e4=`${Xf}/api/usuarios/historiallider/`,t4=`${Xf}/api/usuarios/historialSupervisor/`,n4=()=>{const[e,t]=w.useState(""),[n,r]=w.useState(""),[o,i]=w.useState([]),[s,l]=w.useState([]),u=ge(),{id:c}=cr(),d=localStorage.getItem("token"),f=async v=>{v.preventDefault();try{await P.put(l0+c,{id_supervisor:e,id_lider:n},{headers:{Authorization:`Bearer ${d}`}}),u("/asignarSupervisor")}catch(g){console.error("Error al actualizar la asignación",g)}};w.useEffect(()=>{const v=async()=>{try{const b=await P.get(e4,{headers:{Authorization:`Bearer ${d}`}});i(b.data)}catch(b){console.error("Error al obtener Liders",b)}},g=async()=>{try{const b=await P.get(t4,{headers:{Authorization:`Bearer ${d}`}});l(b.data)}catch(b){console.error("Error al obtener Supervisores",b)}};(async()=>{try{const b=await P.get(l0+c,{headers:{Authorization:`Bearer ${d}`}});t(b.data.id_supervisor),r(b.data.id_lider)}catch(b){console.error("Error al obtener los datos del usuario",b)}})(),v(),g()},[d,c]);const h=()=>{u("/asignarSupervisor")};return a.jsx(r4,{children:a.jsx(o4,{children:a.jsxs("div",{className:"form-wrapper",children:[a.jsx("h3",{children:"Editar Asignación de Supervisor"}),a.jsxs("form",{onSubmit:f,children:[a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Líder"}),a.jsxs("select",{value:n,onChange:v=>r(v.target.value),className:"form-control",children:[a.jsx("option",{value:"",children:"Seleccionar Líder"}),o.map(v=>a.jsxs("option",{value:v.id_usuario,children:[v.nombre," ",v.apellido," (ID: ",v.id_usuario,")"]},v.id_usuario))]})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Supervisor"}),a.jsxs("select",{value:e,onChange:v=>t(v.target.value),className:"form-control",children:[a.jsx("option",{value:"",children:"Seleccionar Supervisor"}),s.map(v=>a.jsxs("option",{value:v.id_usuario,children:[v.nombre," ",v.apellido," (ID: ",v.id_usuario,")"]},v.id_usuario))]})]}),a.jsxs("div",{className:"button-group",children:[a.jsx("button",{type:"submit",className:"btn btn-primary",children:"Guardar"}),a.jsx("button",{type:"button",className:"btn btn-secondary",onClick:h,children:"Cancelar"})]})]})]})})})},r4=k.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100vh;
...
`,oP="https://backend-riosdevida-production.up.railway.app",h0=`${oP}/api/planilla/`,iP=()=>{const[e,t]=w.useState(""),[n,r]=w.useState(""),[o,i]=w.useState(""),[s,l]=w.useState(""),[u,c]=w.useState(""),[d,f]=w.useState(""),[h,v]=w.useState(""),[g,S]=w.useState(""),[b,x]=w.useState(""),m=ge(),{id:p}=cr(),y=localStorage.getItem("token"),j=async E=>{E.preventDefault(),await P.put(h0+p,{anfitrion:e,ayudante:n,total_invitados:o,total_jov_adult:s,total_ninos:u,total_participantes:d,conv_rec:h,ofrenda:g,fecha:b},{headers:{Authorization:`Bearer ${y}`}}),m("/planillaGeneralSupervisor")};w.useEffect(()=>{C()},[]);const C=async()=>{const E=await P.get(h0+p,{headers:{Authorization:`Bearer ${y}`}}),{anfitrion:A,ayudante:O,total_invitados:te,total_jov_adult:Se,total_ninos:N,total_participantes:ye,conv_rec:dr,ofrenda:pn,fecha:Ot}=E.data;t(A),r(O),i(te),l(Se),c(N),f(ye),v(dr),S(pn),x(Ot)},$=()=>{m("/planillaGeneralSupervisor")};return a.jsx(sP,{children:a.jsx(aP,{children:a.jsxs("div",{className:"form-wrapper",children:[a.jsx("h3",{children:"Editar Planilla"}),a.jsxs("form",{onSubmit:j,children:[a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Anfitrion"}),a.jsx("input",{value:e,onChange:E=>t(E.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Ayudante"}),a.jsx("input",{value:n,onChange:E=>r(E.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Invitados"}),a.jsx("input",{value:o,onChange:E=>i(E.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Jóvenes/Adultos"}),a.jsx("input",{value:s,onChange:E=>l(E.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Niños"}),a.jsx("input",{value:u,onChange:E=>c(E.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Participantes"}),a.jsx("input",{value:d,onChange:E=>f(E.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Convertidos"}),a.jsx("input",{value:h,onChange:E=>v(E.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Ofrenda"}),a.jsx("input",{value:g,onChange:E=>S(E.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Fecha"}),a.jsx("input",{value:b,onChange:E=>x(E.target.value),type:"date",className:"form-control"})]}),a.jsxs("div",{className:"button-group",children:[a.jsx("button",{type:"submit",className:"btn btn-primary",children:"Guardar"}),a.jsx("button",{type:"button",className:"btn btn-secondary",onClick:$,children:"Cancelar"})]})]})]})})})},sP=k.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100vh;
...
`,ET=()=>{const e=[X.auditorioUno,X.auditorioDos,X.auditorioTres,X.auditorioCuatro,X.auditorioCinco],[t,n]=w.useState(0),[r,o]=w.useState(!1);return w.useEffect(()=>{const i=setInterval(()=>{n(s=>(s+1)%e.length)},5e3);return()=>clearInterval(i)},[e.length]),w.useEffect(()=>{const i=()=>{const s=document.getElementById("evento-section-cuatro");if(s){const l=s.getBoundingClientRect(),u=window.innerHeight,c=l.top<u*.8&&l.bottom>u*.2;o(c)}};return window.addEventListener("scroll",i),i(),()=>{window.removeEventListener("scroll",i)}},[]),a.jsxs(jT,{id:"evento-section-cuatro",children:[a.jsx(kT,{style:{backgroundImage:`url(${e[t]})`},isVisible:r}),a.jsxs(CT,{isVisible:r,children:[a.jsx("h1",{children:"Convención de Mujeres"}),a.jsx("p",{children:"La convención de mujeres es un evento anual que reúne a mujeres de diversas localidades, Para compartir fortalecer y apoyar a las mujeres en el crecimiento de su Fe y en su vida diaria. Este evento es una oportunidad para aprender, crecer y conectarse con otras mujeres que comparten la misma fe y valores."})]})]})},$T=k.div`
...
`,WT=k.img`
  width: 100%;
  border-radius: 10px;
`,qT=()=>{const[e,t]=w.useState(!1),[n,r]=w.useState(!1);w.useEffect(()=>{const i=()=>{const s=document.getElementById("eventos-section");if(s){const l=s.getBoundingClientRect(),u=window.innerHeight,c=l.top<u*.8&&l.bottom>u*.2;t(c)}};return window.addEventListener("scroll",i),i(),()=>window.removeEventListener("scroll",i)},[]);const o=()=>r(!0);return a.jsxs(DT,{children:[a.jsx(FT,{autoPlay:!0,loop:!0,muted:!0,onCanPlay:o,style:{opacity:n?1:0},children:a.jsx("source",{src:OT,type:"video/mp4"})}),a.jsxs(MT,{id:"eventos-section",children:[a.jsxs(BT,{isVisible:e,children:[a.jsx(UT,{children:"Somos una iglesia de eventos"}),a.jsx(VT,{children:"Creemos en la importancia de compartir momentos significativos en comunidad. Nuestros eventos están diseñados para unir a las personas, fortalecer la fe y crear recuerdos inolvidables. ¡Descubre nuestras próximas actividades!"})]}),a.jsx(HT,{isVisible:e,children:a.jsx(WT,{src:AT,alt:"Eventos en nuestra iglesia"})})]})]})},GT=fn`
  from { opacity: 0; }
  to { opacity: 1; }
`,JT=k.div`
  position: relative;
...
`,QT=()=>{const e=[X.auditorioUno,X.auditorioDos,X.auditorioTres,X.auditorioCuatro,X.auditorioCinco],[t,n]=w.useState(0),[r,o]=w.useState(!1);return w.useEffect(()=>{const i=setInterval(()=>{n(s=>(s+1)%e.length)},5e3);return()=>clearInterval(i)},[e.length]),w.useEffect(()=>{const i=()=>{const s=document.getElementById("evento-section-cinco");if(s){const l=s.getBoundingClientRect(),u=window.innerHeight,c=l.top<u*.8&&l.bottom>u*.2;o(c)}};return window.addEventListener("scroll",i),i(),()=>{window.removeEventListener("scroll",i)}},[]),a.jsxs(JT,{id:"evento-section-cinco",children:[a.jsxs(XT,{isVisible:r,children:[a.jsx("h1",{children:"Convención de Niños"}),a.jsx("p",{children:"La convención de niños es un evento anual que reúne a niños de diversas localidades para tener un momento de aprendizaje y fortalcer su confianza y Fe desde una edad temprana, todo esto de una manera divertida y amena. Este evento es una oportunidad para que los niños se conecten con otros de su edad, aprendan sobre la importancia de la fe y la comunidad, y desarrollen habilidades sociales y emocionales."})]}),a.jsx(KT,{style:{backgroundImage:`url(${e[t]})`},isVisible:r})]})};function YT(){return a.jsxs(a.Fragment,{children:[a.jsx(Cl,{}),a.jsx(bf,{}),a.jsxs(ZT,{children:[a.jsx(qT,{}),a.jsx(PT,{}),a.jsx(zT,{}),a.jsx(ET,{}),a.jsx(QT,{})]}),a.jsx(yf,{})]})}const ZT=k.div`
