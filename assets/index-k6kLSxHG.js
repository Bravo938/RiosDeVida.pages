...
`,v0=["Dios Te Ama","Hey! Cuando no sepas a dónde ir, andá a Dios; Él te sigue esperando.","Tu tienes un gran valor para Dios","Yo siempre estoy contigo. att: Dios","Jesús te ama una banda","Sos muy Importante Para Mí, att: Dios","A pesar de todo te sigo Amando, att: Dios","No estoy enojado con vos, Te amo, att: Dios"],b4=()=>{const[e,t]=w.useState("");return w.useEffect(()=>{const n=Math.floor(Math.random()*v0.length);t(v0[n])},[]),a.jsxs(j4,{children:[a.jsx(hx,{}),a.jsx(k4,{children:a.jsx("div",{className:"icon",children:a.jsx(G,{to:"/",children:a.jsx(iC,{})})})}),a.jsx(E4,{children:a.jsx(C4,{children:e})})]})},j4=E.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
...
`;function _4(){const{auth:e,setAuth:t}=w.useContext(Zi);return w.useEffect(()=>{const n=localStorage.getItem("token");n&&t({token:n})},[t]),a.jsx(a.Fragment,{children:a.jsxs(bb,{children:[a.jsx(Q,{path:"/login",element:a.jsx(W2,{})}),a.jsx(Q,{path:"/",element:a.jsx(rC,{})}),a.jsx(Q,{path:"/notas",element:a.jsx(b4,{})}),e&&e.token?a.jsxs(Q,{element:a.jsx(aC,{}),children:[a.jsx(Q,{path:"/*",element:a.jsx(dC,{})}),a.jsx(Q,{path:"/logout",element:a.jsx(n_,{})}),a.jsx(Q,{path:"/planillaLider",element:a.jsx(_3,{})}),a.jsx(Q,{path:"/planillaGeneralSupervisor",element:a.jsx(zP,{})}),a.jsx(Q,{path:"/asistencia",element:a.jsx(B3,{})}),a.jsx(Q,{path:"/asistenciaVistaSupervisor",element:a.jsx($P,{})}),a.jsx(Q,{path:"/asistenciaVistaAdmin",element:a.jsx(u4,{})}),a.jsx(Q,{path:"/registroUsuarios",element:a.jsx(yR,{})}),a.jsx(Q,{path:"/registroDeRoles",element:a.jsx(QR,{})}),a.jsx(Q,{path:"/registroLideryMiembro",element:a.jsx(fP,{})}),a.jsx(Q,{path:"/miembrosLideresSupervisor",element:a.jsx(n4,{})}),a.jsx(Q,{path:"/generalPlanilla",element:a.jsx(J3,{})}),a.jsx(Q,{path:"/planillaGeneralAdmin",element:a.jsx(g4,{})}),a.jsx(Q,{path:"/asignarSupervisor",element:a.jsx(IR,{})}),a.jsx(Q,{path:"/crearMiembro",element:a.jsx(L3,{})}),a.jsx(Q,{path:"/crearPlanillaGeneral",element:a.jsx(oR,{})}),a.jsx(Q,{path:"/crearPlanillaGeneralSupervisor",element:a.jsx(WP,{})}),a.jsx(Q,{path:"/crearAsistencia",element:a.jsx(fR,{})}),a.jsx(Q,{path:"/crearUsuario",element:a.jsx(CR,{})}),a.jsx(Q,{path:"/crearAsignarSupervisor",element:a.jsx(UR,{})}),a.jsx(Q,{path:"/crearUnRol",element:a.jsx(nP,{})}),a.jsx(Q,{path:"/crearMiembroSupervisor",element:a.jsx(yP,{})}),a.jsx(Q,{path:"/editarMiembros/:id",element:a.jsx(z3,{})}),a.jsx(Q,{path:"/editarPlanillaGeneral/:id",element:a.jsx(aR,{})}),a.jsx(Q,{path:"/editarAsistencia/:id",element:a.jsx(mR,{})}),a.jsx(Q,{path:"/editarUsuario/:id",element:a.jsx(RR,{})}),a.jsx(Q,{path:"/editarAsignacionSupervisor/:id",element:a.jsx(WR,{})}),a.jsx(Q,{path:"/editarRol/:id",element:a.jsx(iP,{})}),a.jsx(Q,{path:"/editarMiembroSupervisor/:id",element:a.jsx(bP,{})}),a.jsx(Q,{path:"/editarPlanillaGeneralSupervisor/:id",element:a.jsx(KP,{})})]}):a.jsx(Q,{path:"/*",element:a.jsx(yb,{to:"/"})})]})})}Nv(document.getElementById("root")).render(a.jsx(w.StrictMode,{children:a.jsx(Rb,{children:a.jsx(mC,{children:a.jsx(_4,{})})})}));
