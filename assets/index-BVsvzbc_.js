...
`,ZR="https://backend-riosdevida-production.up.railway.app",s0=`${ZR}/api/roles`;function eP(){const[e,t]=w.useState([]),n=w.useRef(null);w.useEffect(()=>{o()},[]);const r=localStorage.getItem("token"),o=async()=>{try{const l=await P.get(s0,{headers:{Authorization:`Bearer ${r}`}});t(l.data)}catch(l){console.error("Error al obtener los miembros",l),l.response&&l.response.status===401&&console.log("Token expiró")}},i=async l=>{if(window.confirm("¿Estás seguro de que deseas eliminar este miembro?"))try{await P.delete(`${s0}/${l}`,{headers:{Authorization:`Bearer ${r}`}}),o()}catch(u){console.error("Error al eliminar un Miembro:",u)}},{onDownload:s}=St.useDownloadExcel({currentTableRef:n.current,filename:"Tabla de Usuarios",sheet:"Usuarios"});return a.jsxs(tP,{children:[a.jsx(nP,{children:a.jsx("div",{children:a.jsx(G,{to:"/menuInicio",children:a.jsx(bt,{})})})}),a.jsxs(rP,{children:[a.jsxs(G,{to:"/crearUnRol",className:"btn btn-primary create-client",children:[a.jsx(Rn,{})," Crear Un Rol"]}),a.jsxs("button",{onClick:s,className:"btn btn-primary download-client",children:[a.jsx(Lt,{})," Descargar Roles"]})]}),a.jsxs(oP,{striped:!0,bordered:!0,hover:!0,ref:n,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{children:"#"}),a.jsx("th",{children:"Nombre Del Rol"}),a.jsx("th",{children:"Descripcion"}),a.jsx("th",{children:"Boton"})]})}),a.jsx("tbody",{children:e.map((l,u)=>a.jsxs("tr",{children:[a.jsx("td",{children:u+1}),a.jsx("td",{children:l.nombre_rol}),a.jsx("td",{children:l.descripcion}),a.jsxs("td",{children:[a.jsx(G,{to:`/editarRol/${l.id_rol}`,className:"btn btn-info",children:a.jsx(Tt,{})}),a.jsx("button",{onClick:()=>i(l.id_rol),className:"btn btn-danger",children:a.jsx(It,{})})]})]},l.id_rol))})]})]})}const tP=k.div`
  padding: 100px 2px;
  min-height: 100vh; 
  overflow-x: auto;
`,nP=k.div`
...
`,iP="https://backend-riosdevida-production.up.railway.app",sP=`${iP}/api/roles`,aP=()=>{const[e,t]=w.useState(""),[n,r]=w.useState(""),o=me(),i=localStorage.getItem("token"),s=async u=>{u.preventDefault();try{await P.post(sP,{nombre_rol:e,descripcion:n},{headers:{Authorization:`Bearer ${i}`}}),o("/registroDeRoles")}catch(c){console.error("Error al crear el miembro:",c)}},l=()=>{o("/registroDeRoles")};return a.jsx(lP,{children:a.jsxs("div",{className:"form-wrapper",children:[a.jsx("h3",{children:"Crear Usuario"}),a.jsxs("form",{onSubmit:s,children:[a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Nombre del Rol"}),a.jsx("input",{value:e,onChange:u=>t(u.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Descripcion"}),a.jsx("input",{value:n,onChange:u=>r(u.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"button-group",children:[a.jsx("button",{type:"submit",className:"btn btn-primary",children:"Guardar"}),a.jsx("button",{type:"button",className:"btn btn-secondary",onClick:l,children:"Cancelar"})]})]})]})})},lP=k.div`
    display: flex;
    align-items: center;
    justify-content: center;
    height: 100vh;
...
`,uP="https://backend-riosdevida-production.up.railway.app",a0=`${uP}/api/roles/`,cP=()=>{const[e,t]=w.useState(""),[n,r]=w.useState(""),o=me(),{id:i}=ur(),s=localStorage.getItem("token"),l=async d=>{d.preventDefault(),await P.put(a0+i,{nombre_rol:e,descripcion:n},{headers:{Authorization:`Bearer ${s}`}}),o("/registroDeRoles")};w.useEffect(()=>{u()},[]);const u=async()=>{const d=await P.get(a0+i,{headers:{Authorization:`Bearer ${s}`}});t(d.data.nombre_rol),r(d.data.descripcion)},c=()=>{o("/registroDeRoles")};return a.jsx(dP,{children:a.jsx(fP,{children:a.jsxs("div",{className:"form-wrapper",children:[a.jsx("h3",{children:"Editar Cliente"}),a.jsxs("form",{onSubmit:l,children:[a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Nombre Del Rol"}),a.jsx("input",{value:e,onChange:d=>t(d.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Descripcion"}),a.jsx("input",{value:n,onChange:d=>r(d.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"button-group",children:[a.jsx("button",{type:"submit",className:"btn btn-primary",children:"Guardar"}),a.jsx("button",{type:"button",className:"btn btn-secondary",onClick:c,children:"Cancelar"})]})]})]})})})},dP=k.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100vh;
...
`,Ul="https://backend-riosdevida-production.up.railway.app",pP=`${Ul}/api/supervisorLider/supervisor/`,hP=`${Ul}/api/supervisorLider/supervisorLiderMiembro/`,mP=`${Ul}/api/miembros/lider/`,gP=`${Ul}/api/miembros/`;function vP(){const[e,t]=w.useState([]),[n,r]=w.useState([]),[o,i]=w.useState(""),s=w.useRef(null),l=localStorage.getItem("token"),u=localStorage.getItem("idUser");w.useEffect(()=>{c(),d()},[]);const c=async()=>{try{const g=await P.get(`${pP}${u}`,{headers:{Authorization:`Bearer ${l}`}});r(g.data)}catch(g){console.error("Error al obtener los líderes",g)}},d=async(g="")=>{try{const S=g?`${mP}${g}`:`${hP}${u}`,b=await P.get(S,{headers:{Authorization:`Bearer ${l}`}});t(b.data)}catch(S){console.error("Error al obtener los miembros",S)}},f=g=>{const S=g.target.value;i(S),d(S)},h=async g=>{if(window.confirm("¿Estás seguro de que deseas eliminar este miembro?"))try{await P.delete(`${gP}${g}`,{headers:{Authorization:`Bearer ${l}`}}),d(o)}catch(S){console.error("Error al eliminar un miembro:",S)}},{onDownload:v}=St.useDownloadExcel({currentTableRef:s.current,filename:"Tabla de Miembros",sheet:"Miembros"});return a.jsxs(xP,{children:[a.jsx(yP,{children:a.jsx("div",{children:a.jsx(G,{to:"/menuInicio",children:a.jsx(bt,{})})})}),a.jsxs(wP,{children:[a.jsxs("label",{children:["Filtrar por Líder:",a.jsxs("select",{value:o,onChange:f,children:[a.jsx("option",{value:"",children:"Todos"}),n.map(g=>a.jsxs("option",{value:g.id_lider,children:[g.lider.nombre," ",g.lider.apellido]},g.id_lider))]})]}),a.jsxs(G,{to:"/crearMiembroSupervisor",className:"btn btn-primary create-client",children:[a.jsx(Rn,{})," Crear Miembro"]}),a.jsxs("button",{onClick:v,className:"btn btn-primary download-client",children:[a.jsx(Lt,{})," Descargar Roles"]})]}),a.jsxs(bP,{striped:!0,bordered:!0,hover:!0,ref:s,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{children:"#"}),a.jsx("th",{children:"Nombre"}),a.jsx("th",{children:"Apellido"}),a.jsx("th",{children:"Líder"}),a.jsx("th",{children:"Acciones"})]})}),a.jsx("tbody",{children:e.map((g,S)=>a.jsxs("tr",{children:[a.jsx("td",{children:S+1}),a.jsx("td",{children:g.nombre}),a.jsx("td",{children:g.apellido}),a.jsx("td",{children:g.Líder?`${g.Líder.nombre} ${g.Líder.apellido}`:"@unknown"}),a.jsxs("td",{children:[a.jsx(G,{to:`/editarMiembroSupervisor/${g.id_miembro}`,className:"btn btn-info",children:a.jsx(Tt,{})}),a.jsx("button",{onClick:()=>h(g.id_miembro),className:"btn btn-danger",children:a.jsx(It,{})})]})]},g.id_miembro))})]})]})}const xP=k.div`
  padding: 100px 2px;
  min-height: 100vh;
  overflow-x: auto;
`,yP=k.div`
...
`,e1="https://backend-riosdevida-production.up.railway.app",l0=`${e1}/api/miembros/`,CP=`${e1}/api/supervisorLider/supervisor/`,$P=()=>{const[e,t]=w.useState(""),[n,r]=w.useState(""),[o,i]=w.useState(""),[s,l]=w.useState([]),u=me(),{id:c}=ur(),d=localStorage.getItem("token"),f=localStorage.getItem("idUser"),h=async b=>{b.preventDefault(),await P.put(l0+c,{nombre:e,apellido:n,id_líder:o},{headers:{Authorization:`Bearer ${d}`}}),u("/registroLideryMiembro")};w.useEffect(()=>{g(),v()},[]);const v=async()=>{try{const b=await P.get(`${CP}${f}`,{headers:{Authorization:`Bearer ${d}`}});l(b.data)}catch(b){console.error("Error al obtener los líderes",b)}},g=async()=>{try{const b=await P.get(l0+c,{headers:{Authorization:`Bearer ${d}`}});t(b.data.nombre),r(b.data.apellido),i(b.data.id_líder)}catch(b){console.error("Error al obtener el miembro",b)}},S=()=>{u("/registroLideryMiembro")};return a.jsx(_P,{children:a.jsx(RP,{children:a.jsxs("div",{className:"form-wrapper",children:[a.jsx("h3",{children:"Editar Miembro"}),a.jsxs("form",{onSubmit:h,children:[a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Nombre"}),a.jsx("input",{value:e,onChange:b=>t(b.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Apellido"}),a.jsx("input",{value:n,onChange:b=>r(b.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Líder"}),a.jsxs("select",{value:o,onChange:b=>i(b.target.value),className:"form-control",required:!0,children:[a.jsx("option",{value:"",children:"Seleccionar Líder"}),s.map(b=>a.jsxs("option",{value:b.id_lider,children:[b.lider.nombre," ",b.lider.apellido]},b.id_lider))]})]}),a.jsxs("div",{className:"button-group",children:[a.jsx("button",{type:"submit",className:"btn btn-primary",children:"Guardar"}),a.jsx("button",{type:"button",className:"btn btn-secondary",onClick:S,children:"Cancelar"})]})]})]})})})},_P=k.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100vh;
...
`,Jf="https://backend-riosdevida-production.up.railway.app",PP=`${Jf}/api/asistencia`,NP=`${Jf}/api/asistencia/asistenciaSupervisor/`,TP=`${Jf}/api/supervisorLider/supervisor/`;function IP(){const[e,t]=w.useState([]),[n,r]=w.useState([]),[o,i]=w.useState(""),[s,l]=w.useState([]),[u,c]=w.useState(""),d=w.useRef(null),f=localStorage.getItem("token"),h=localStorage.getItem("idUser");w.useEffect(()=>{v(),g()},[]);const v=async()=>{try{const y=await P.get(`${NP}${h}`,{headers:{Authorization:`Bearer ${f}`}});t(y.data),r(y.data)}catch(y){console.error("Error al obtener las asistencias:",y)}},g=async()=>{try{const y=await P.get(`${TP}${h}`,{headers:{Authorization:`Bearer ${f}`}});l(y.data)}catch(y){console.error("Error al obtener los líderes:",y)}},S=(y,j)=>{let E=e;y&&(E=E.filter($=>$.fecha===y)),j&&(E=E.filter($=>$.id_lider===parseInt(j))),r(E)},b=y=>{const j=y.target.value;i(j),S(j,u)},x=y=>{const j=y.target.value;c(j),S(o,j)},m=async y=>{if(window.confirm("¿Estás seguro de que deseas eliminar esta asistencia?"))try{await P.delete(`${PP}/${y}`,{headers:{Authorization:`Bearer ${f}`}});const j=e.filter($=>$.id_miembro_planilla!==y);t(j);const E=j.filter($=>{const C=!o||$.fecha===o,O=!u||$.id_lider===parseInt(u);return C&&O});r(E)}catch(j){console.error("Error al eliminar la asistencia:",j)}},{onDownload:p}=St.useDownloadExcel({currentTableRef:d.current,filename:"Asistencias",sheet:"Asistencias"});return a.jsxs(LP,{children:[a.jsx(AP,{children:a.jsx("div",{children:a.jsx(G,{to:"/menuInicio",children:a.jsx(bt,{})})})}),a.jsx(OP,{children:a.jsxs("button",{onClick:p,className:"btn btn-primary download-client",children:[a.jsx(Lt,{})," Descargar Asistencia"]})}),a.jsxs(zP,{children:[a.jsxs(u0,{children:[a.jsx("label",{htmlFor:"filter-date",children:"Filtrar por fecha:"}),a.jsx("input",{type:"date",id:"filter-date",value:o,onChange:b})]}),a.jsxs(u0,{children:[a.jsx("label",{htmlFor:"filter-lider",children:"Filtrar por líder:"}),a.jsxs("select",{id:"filter-lider",value:u,onChange:x,children:[a.jsx("option",{value:"",children:"Todos"}),s.map(y=>a.jsxs("option",{value:y.id_lider,children:[y.lider.nombre," ",y.lider.apellido]},y.id_lider))]})]})]}),a.jsxs(DP,{striped:!0,bordered:!0,hover:!0,ref:d,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{children:"#"}),a.jsx("th",{children:"Nombre y Apellido"}),a.jsx("th",{children:"Asistencia"}),a.jsx("th",{children:"Lider"}),a.jsx("th",{children:"Fecha"}),a.jsx("th",{children:"Botones"})]})}),a.jsx("tbody",{children:n.map((y,j)=>a.jsxs("tr",{children:[a.jsx("td",{children:j+1}),a.jsx("td",{children:y.miembro?`${y.miembro.nombre} ${y.miembro.apellido}`:"Miembro eliminado"}),a.jsx("td",{children:y.asistencia}),a.jsx("td",{children:y.lider?`${y.lider.nombre} ${y.lider.apellido}`:"No se encuentra Lider"}),a.jsx("td",{children:y.fecha}),a.jsxs("td",{children:[a.jsx(G,{to:`/editarAsistencia/${y.id_miembro_planilla}`,className:"btn btn-info",children:a.jsx(Tt,{})}),a.jsx("button",{onClick:()=>m(y.id_miembro_planilla),className:"btn btn-danger",children:a.jsx(It,{})})]})]},y.id_miembro_planilla))})]})]})}const LP=k.div`
  padding: 100px 2px;
  min-height: 100vh;
  overflow-x: auto;
`,AP=k.div`
...
`,Kf="https://backend-riosdevida-production.up.railway.app",MP=`${Kf}/api/planilla`,FP=`${Kf}/api/planilla/planillasLiderSupervisor/`,UP=`${Kf}/api/supervisorLider/supervisor/`;function BP(){const[e,t]=w.useState([]),[n,r]=w.useState([]),[o,i]=w.useState(""),[s,l]=w.useState(""),[u,c]=w.useState([]),d=w.useRef(null);w.useEffect(()=>{g(),v()},[]);const f=localStorage.getItem("token"),h=localStorage.getItem("idUser"),v=async()=>{try{const y=await P.get(`${UP}${h}`,{headers:{Authorization:`Bearer ${f}`}});c(y.data)}catch(y){console.error("Error al obtener los líderes:",y)}},g=async()=>{try{const y=await P.get(`${FP}${h}`,{headers:{Authorization:`Bearer ${f}`}});t(y.data),r(y.data)}catch(y){console.error("Error al obtener las planillas:",y)}},S=y=>{const j=y.target.value;i(j),x(j,s)},b=y=>{const j=y.target.value;l(j),x(o,j)},x=(y,j)=>{let E=e;y&&(E=E.filter($=>$.fecha===y)),j&&(E=E.filter($=>$.id_lider.toString()===j)),r(E)},m=async y=>{if(window.confirm("¿Estás seguro de que deseas eliminar esta Planilla?"))try{await P.delete(`${MP}/${y}`,{headers:{Authorization:`Bearer ${f}`}}),g()}catch(j){console.error("Error al eliminar la planilla:",j)}},{onDownload:p}=St.useDownloadExcel({currentTableRef:d.current,filename:"Planillas_Celulas",sheet:"Planillas"});return a.jsxs(HP,{children:[a.jsx(VP,{children:a.jsx(G,{to:"/menuInicio",children:a.jsx(bt,{})})}),a.jsxs(WP,{children:[a.jsxs(G,{to:"/crearPlanillaGeneralSupervisor",className:"btn btn-primary create-client",children:[a.jsx(Rn,{})," Crear Planilla"]}),a.jsxs("button",{onClick:p,className:"btn btn-primary download-client",children:[a.jsx(Lt,{})," Descargar Planillas"]})]}),a.jsxs(GP,{children:[a.jsxs(c0,{children:[a.jsx("label",{htmlFor:"filter-date",children:"Filtrar por fecha:"}),a.jsx("input",{type:"date",id:"filter-date",value:o,onChange:S})]}),a.jsxs(c0,{children:[a.jsx("label",{htmlFor:"filter-lider",children:"Filtrar por líder:"}),a.jsxs("select",{id:"filter-lider",value:s,onChange:b,children:[a.jsx("option",{value:"",children:"Todos"}),u.map(y=>a.jsx("option",{value:y.id_lider,children:`${y.lider.nombre} ${y.lider.apellido}`},y.id_lider))]})]})]}),a.jsxs(qP,{striped:!0,bordered:!0,hover:!0,ref:d,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{children:"#"}),a.jsx("th",{children:"Número de Planilla"}),a.jsx("th",{children:"Líder"}),a.jsx("th",{children:"Supervisor"}),a.jsx("th",{children:"Anfitrión"}),a.jsx("th",{children:"Ayudante"}),a.jsx("th",{children:"Total Invitados"}),a.jsx("th",{children:"Total Jóvenes Adultos"}),a.jsx("th",{children:"Total Niños"}),a.jsx("th",{children:"Total Participantes"}),a.jsx("th",{children:"Total Convertidos"}),a.jsx("th",{children:"Ofrenda"}),a.jsx("th",{children:"Fecha"}),a.jsx("th",{children:"Acciones"})]})}),a.jsx("tbody",{children:n.map((y,j)=>a.jsxs("tr",{children:[a.jsx("td",{children:j+1}),a.jsx("td",{children:y.id_planilla}),a.jsx("td",{children:`${y.Lider.nombre} ${y.Lider.apellido}`}),a.jsx("td",{children:`${y.Supervisor.nombre} ${y.Supervisor.apellido}`}),a.jsx("td",{children:y.anfitrion}),a.jsx("td",{children:y.ayudante}),a.jsx("td",{children:y.total_invitados}),a.jsx("td",{children:y.total_jov_adult}),a.jsx("td",{children:y.total_ninos}),a.jsx("td",{children:y.total_participantes}),a.jsx("td",{children:y.conv_rec}),a.jsx("td",{children:y.ofrenda}),a.jsx("td",{children:y.fecha}),a.jsxs("td",{children:[a.jsx(G,{to:`/editarPlanillaGeneralSupervisor/${y.id_planilla}`,className:"btn btn-info",children:a.jsx(Tt,{})}),a.jsx("button",{onClick:()=>m(y.id_planilla),className:"btn btn-danger",children:a.jsx(It,{})})]})]},y.id_planilla))})]})]})}const HP=k.div`
  padding: 100px 2px;
  min-height: 100vh; 
  overflow-x: auto;
`,VP=k.div`
...
`,YP="https://backend-riosdevida-production.up.railway.app",d0=`${YP}/api/planilla/`,ZP=()=>{const[e,t]=w.useState(""),[n,r]=w.useState(""),[o,i]=w.useState(""),[s,l]=w.useState(""),[u,c]=w.useState(""),[d,f]=w.useState(""),[h,v]=w.useState(""),[g,S]=w.useState(""),[b,x]=w.useState(""),m=me(),{id:p}=ur(),y=localStorage.getItem("token"),j=async C=>{C.preventDefault(),await P.put(d0+p,{anfitrion:e,ayudante:n,total_invitados:o,total_jov_adult:s,total_ninos:u,total_participantes:d,conv_rec:h,ofrenda:g,fecha:b},{headers:{Authorization:`Bearer ${y}`}}),m("/planillaGeneralSupervisor")};w.useEffect(()=>{E()},[]);const E=async()=>{const C=await P.get(d0+p,{headers:{Authorization:`Bearer ${y}`}}),{anfitrion:O,ayudante:z,total_invitados:ee,total_jov_adult:be,total_ninos:T,total_participantes:xe,conv_rec:cr,ofrenda:fn,fecha:Ot}=C.data;t(O),r(z),i(ee),l(be),c(T),f(xe),v(cr),S(fn),x(Ot)},$=()=>{m("/planillaGeneralSupervisor")};return a.jsx(e4,{children:a.jsx(t4,{children:a.jsxs("div",{className:"form-wrapper",children:[a.jsx("h3",{children:"Editar Planilla"}),a.jsxs("form",{onSubmit:j,children:[a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Anfitrion"}),a.jsx("input",{value:e,onChange:C=>t(C.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Ayudante"}),a.jsx("input",{value:n,onChange:C=>r(C.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Invitados"}),a.jsx("input",{value:o,onChange:C=>i(C.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Jóvenes/Adultos"}),a.jsx("input",{value:s,onChange:C=>l(C.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Niños"}),a.jsx("input",{value:u,onChange:C=>c(C.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Participantes"}),a.jsx("input",{value:d,onChange:C=>f(C.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Total Convertidos"}),a.jsx("input",{value:h,onChange:C=>v(C.target.value),type:"text",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Ofrenda"}),a.jsx("input",{value:g,onChange:C=>S(C.target.value),type:"number",className:"form-control"})]}),a.jsxs("div",{className:"mb-3",children:[a.jsx("label",{className:"form-label",children:"Fecha"}),a.jsx("input",{value:b,onChange:C=>x(C.target.value),type:"date",className:"form-control"})]}),a.jsxs("div",{className:"button-group",children:[a.jsx("button",{type:"submit",className:"btn btn-primary",children:"Guardar"}),a.jsx("button",{type:"button",className:"btn btn-secondary",onClick:$,children:"Cancelar"})]})]})]})})})},e4=k.div`
    display: flex;
    justify-content: center;
    align-items: center;
    height: 100vh;
...
`,ns="https://backend-riosdevida-production.up.railway.app",n4=`${ns}/api/supervisorLider/supervisor/`,r4=`${ns}/api/miembros/lider/`,o4=`${ns}/api/miembros/`,i4=`${ns}/api/usuarios/historiallider/`,s4=`${ns}/api/usuarios/historialSupervisor/`;function a4(){const[e,t]=w.useState([]),[n,r]=w.useState([]),[o,i]=w.useState([]),[s,l]=w.useState(""),[u,c]=w.useState(""),d=w.useRef(null),f=localStorage.getItem("token");localStorage.getItem("idUser"),w.useEffect(()=>{h(),g(),v()},[]);const h=async()=>{try{const p=await P.get(i4,{headers:{Authorization:`Bearer ${f}`}});r(p.data)}catch(p){console.error("Error al obtener los líderes",p)}},v=async()=>{try{const p=await P.get(s4,{headers:{Authorization:`Bearer ${f}`}});i(p.data)}catch(p){console.error("Error al obtener los líderes",p)}},g=async(p="",y="")=>{try{let j=p?`${r4}${p}`:`${n4}${y}`;const E=await P.get(j,{headers:{Authorization:`Bearer ${f}`}});t(E.data)}catch(j){console.error("Error al obtener los miembros:",j)}},S=p=>{const y=p.target.value;l(y),c(""),g(y,"")},b=p=>{const y=p.target.value;c(y),l(""),g("",y)},x=async p=>{if(window.confirm("¿Estás seguro de que deseas eliminar este miembro?"))try{await P.delete(`${o4}${p}`,{headers:{Authorization:`Bearer ${f}`}}),g(s),console.log(g)}catch(y){console.error("Error al eliminar un miembro:",y)}},{onDownload:m}=St.useDownloadExcel({currentTableRef:d.current,filename:"Tabla de Miembros",sheet:"Miembros"});return a.jsxs(l4,{children:[a.jsx(u4,{children:a.jsx("div",{children:a.jsx(G,{to:"/menuInicio",children:a.jsx(bt,{})})})}),a.jsx(c4,{children:a.jsxs("button",{onClick:m,className:"btn btn-primary download-client",children:[a.jsx(Lt,{})," Descargar"]})}),a.jsxs(f4,{children:[a.jsx(f0,{children:a.jsxs("label",{children:["Filtrar por Líder:",a.jsxs("select",{value:s,onChange:S,children:[a.jsx("option",{value:"",children:"Todos"}),n.map(p=>a.jsxs("option",{value:p.id_usuario,children:[p.nombre," ",p.apellido]},p.id_lider))]})]})}),a.jsx(f0,{children:a.jsxs("label",{children:["Filtrar por Supervisor:",a.jsxs("select",{value:u,onChange:b,children:[a.jsx("option",{value:"",children:"Todos"}),o.map(p=>a.jsxs("option",{value:p.id_usuario,children:[p.nombre," ",p.apellido]},p.id_lider))]})]})})]}),a.jsxs(d4,{striped:!0,bordered:!0,hover:!0,ref:d,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{children:"#"}),a.jsx("th",{children:"Nombre"}),a.jsx("th",{children:"Apellido"}),a.jsx("th",{children:"Accion"})]})}),a.jsx("tbody",{children:e.map((p,y)=>a.jsxs("tr",{children:[a.jsx("td",{children:y+1}),a.jsx("td",{children:p.nombre?p.nombre:`${p.lider.nombre}`}),a.jsx("td",{children:p.apellido?p.apellido:`${p.lider.apellido}`}),a.jsxs("td",{children:[a.jsx(G,{to:`/editarMiembroSupervisor/${p.id_miembro}`,className:"btn btn-info",children:a.jsx(Tt,{})}),a.jsx("button",{onClick:()=>x(p.id_miembro),className:"btn btn-danger",children:a.jsx(It,{})})]})]},p.id_usuario))})]})]})}const l4=k.div`
  padding: 100px 2px;
  min-height: 100vh;
  overflow-x: auto;
`,u4=k.div`
...
`,n1="https://backend-riosdevida-production.up.railway.app",p0=`${n1}/api/asistencia`,p4=`${n1}/api/usuarios/historiallider`;function h4(){const[e,t]=w.useState([]),[n,r]=w.useState([]),[o,i]=w.useState(""),[s,l]=w.useState([]),[u,c]=w.useState(""),d=w.useRef(null),f=localStorage.getItem("token");localStorage.getItem("idUser"),w.useEffect(()=>{h(),v()},[]);const h=async()=>{try{const p=await P.get(p0,{headers:{Authorization:`Bearer ${f}`}});t(p.data),r(p.data)}catch(p){console.error("Error al obtener las asistencias:",p)}},v=async()=>{try{const p=await P.get(p4,{headers:{Authorization:`Bearer ${f}`}});l(p.data)}catch(p){console.error("Error al obtener los líderes:",p)}},g=(p,y)=>{let j=e;p&&(j=j.filter(E=>E.fecha===p)),y&&(j=j.filter(E=>String(E.id_lider)===y)),r(j)},S=p=>{const y=p.target.value;i(y),g(y,u)},b=p=>{const y=p.target.value;c(y),g(o,y)},x=async p=>{if(window.confirm("¿Estás seguro de que deseas eliminar esta asistencia?"))try{await P.delete(`${p0}/${p}`,{headers:{Authorization:`Bearer ${f}`}});const y=e.filter(E=>E.id_miembro_planilla!==p);t(y);const j=y.filter(E=>{const $=!o||E.fecha===o,C=!u||E.id_lider===parseInt(u);return $&&C});r(j)}catch(y){console.error("Error al eliminar la asistencia:",y)}},{onDownload:m}=St.useDownloadExcel({currentTableRef:d.current,filename:"Asistencias",sheet:"Asistencias"});return a.jsxs(m4,{children:[a.jsx(g4,{children:a.jsx("div",{children:a.jsx(G,{to:"/menuInicio",children:a.jsx(bt,{})})})}),a.jsx(v4,{children:a.jsxs("button",{onClick:m,className:"btn btn-primary download-client",children:[a.jsx(Lt,{})," Descargar Asistencia"]})}),a.jsxs(x4,{children:[a.jsxs(h0,{children:[a.jsx("label",{htmlFor:"filter-date",children:"Filtrar por fecha:"}),a.jsx("input",{type:"date",id:"filter-date",value:o,onChange:S})]}),a.jsxs(h0,{children:[a.jsx("label",{htmlFor:"filter-lider",children:"Filtrar por líder:"}),a.jsxs("select",{id:"filter-lider",value:u,onChange:b,children:[a.jsx("option",{value:"",children:"Todos"}),s.map(p=>a.jsxs("option",{value:String(p.id_usuario),children:[p.nombre," ",p.apellido]},p.id_usuario))]})]})]}),a.jsxs(y4,{striped:!0,bordered:!0,hover:!0,ref:d,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{children:"#"}),a.jsx("th",{children:"Nombre y Apellido"}),a.jsx("th",{children:"Asistencia"}),a.jsx("th",{children:"Lider"}),a.jsx("th",{children:"Fecha"}),a.jsx("th",{children:"Botones"})]})}),a.jsx("tbody",{children:n.map((p,y)=>a.jsxs("tr",{children:[a.jsx("td",{children:y+1}),a.jsx("td",{children:p.miembro?`${p.miembro.nombre} ${p.miembro.apellido}`:"Miembro eliminado"}),a.jsx("td",{children:p.asistencia}),a.jsx("td",{children:p.lider?`${p.lider.nombre} ${p.lider.apellido}`:"No se encuentra Lider"}),a.jsx("td",{children:p.fecha}),a.jsxs("td",{children:[a.jsx(G,{to:`/editarAsistencia/${p.id_miembro_planilla}`,className:"btn btn-info",children:a.jsx(Tt,{})}),a.jsx("button",{onClick:()=>x(p.id_miembro_planilla),className:"btn btn-danger",children:a.jsx(It,{})})]})]},p.id_miembro_planilla))})]})]})}const m4=k.div`
  padding: 100px 2px;
  min-height: 100vh;
  overflow-x: auto;
`,g4=k.div`
...
`,L4=()=>a.jsx(T4,{children:a.jsxs(I4,{children:[a.jsx("h1",{children:"Misión 1x1"}),a.jsx("p",{children:"Nuestro objetivo  es enseñar a los jóvenes cristianos el principio 1x1. Que se basa en llevar a un amigo al #JesusFest e    invertir en la vida de esta persona con la intención de compartir el amor de Jesús, el cual cambia corazones."})]})}),A4=kl`
  0% {
...
`,D4=k.h1`
    ...
    color: #fff;
    text-transform: uppercase;
    animation: ${A4} 1.5s infinite alternate;

    @media (max-width: 768px) {
        font-size: 30px;
    }
`,M4=()=>a.jsx(O4,{children:a.jsx(z4,{children:a.jsx(D4,{children:"Potenciados"})})});function F4(){return a.jsxs(a.Fragment,{children:[a.jsx(M4,{}),a.jsx(L4,{}),a.jsx(hx,{})]})}function U4(){const{auth:e,setAuth:t}=w.useContext(Zi);return w.useEffect(()=>{const n=localStorage.getItem("token");n&&t({token:n})},[t]),a.jsx(a.Fragment,{children:a.jsxs(jS,{children:[a.jsx(J,{path:"/login",element:a.jsx(Q2,{})}),a.jsx(J,{path:"/jovenes",element:a.jsx(F4,{})}),a.jsx(J,{path:"/",element:a.jsx(lC,{})}),a.jsx(J,{path:"/notas",element:a.jsx($4,{})}),e&&e.token?a.jsxs(J,{element:a.jsx(fC,{}),children:[a.jsx(J,{path:"/*",element:a.jsx(gC,{})}),a.jsx(J,{path:"/logout",element:a.jsx(a$,{})}),a.jsx(J,{path:"/planillaLider",element:a.jsx(T3,{})}),a.jsx(J,{path:"/planillaGeneralSupervisor",element:a.jsx(BP,{})}),a.jsx(J,{path:"/asistencia",element:a.jsx(G3,{})}),a.jsx(J,{path:"/asistenciaVistaSupervisor",element:a.jsx(IP,{})}),a.jsx(J,{path:"/asistenciaVistaAdmin",element:a.jsx(h4,{})}),a.jsx(J,{path:"/registroUsuarios",element:a.jsx(kR,{})}),a.jsx(J,{path:"/registroDeRoles",element:a.jsx(eP,{})}),a.jsx(J,{path:"/registroLideryMiembro",element:a.jsx(vP,{})}),a.jsx(J,{path:"/miembrosLideresSupervisor",element:a.jsx(a4,{})}),a.jsx(J,{path:"/generalPlanilla",element:a.jsx(tR,{})}),a.jsx(J,{path:"/planillaGeneralAdmin",element:a.jsx(b4,{})}),a.jsx(J,{path:"/asignarSupervisor",element:a.jsx(DR,{})}),a.jsx(J,{path:"/crearMiembro",element:a.jsx(M3,{})}),a.jsx(J,{path:"/crearPlanillaGeneral",element:a.jsx(uR,{})}),a.jsx(J,{path:"/crearPlanillaGeneralSupervisor",element:a.jsx(QP,{})}),a.jsx(J,{path:"/crearAsistencia",element:a.jsx(vR,{})}),a.jsx(J,{path:"/crearUsuario",element:a.jsx(NR,{})}),a.jsx(J,{path:"/crearAsignarSupervisor",element:a.jsx(qR,{})}),a.jsx(J,{path:"/crearUnRol",element:a.jsx(aP,{})}),a.jsx(J,{path:"/crearMiembroSupervisor",element:a.jsx(kP,{})}),a.jsx(J,{path:"/editarMiembros/:id",element:a.jsx(B3,{})}),a.jsx(J,{path:"/editarPlanillaGeneral/:id",element:a.jsx(fR,{})}),a.jsx(J,{path:"/editarAsistencia/:id",element:a.jsx(wR,{})}),a.jsx(J,{path:"/editarUsuario/:id",element:a.jsx(LR,{})}),a.jsx(J,{path:"/editarAsignacionSupervisor/:id",element:a.jsx(QR,{})}),a.jsx(J,{path:"/editarRol/:id",element:a.jsx(cP,{})}),a.jsx(J,{path:"/editarMiembroSupervisor/:id",element:a.jsx($P,{})}),a.jsx(J,{path:"/editarPlanillaGeneralSupervisor/:id",element:a.jsx(ZP,{})})]}):a.jsx(J,{path:"/*",element:a.jsx(wS,{to:"/"})})]})})}Nv(document.getElementById("root")).render(a.jsx(w.StrictMode,{children:a.jsx(PS,{children:a.jsx(wC,{children:a.jsx(U4,{})})})}));
